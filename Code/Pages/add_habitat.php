...
$sendtosql = "SELECT * FROM habitats;";
$result = $conn->query($sendtosql);

if(isset($_POST["subhabi"])){
    $newhabname = $_POST["habi"];
    $newhabDescri = $_POST["descri"];
    
    $newhabi = "INSERT INTO habitats (habi_description, nom_habi)
                            ...
                            <tbody class="bg-white">
                                ...
                                foreach ($result as $resul){
                                        ...
                                        <tr class='border-b'>
                                            ...
                                            <a href='./delete_habitat.php?id=".$resul['id_habi']."'>Delete</a>
                                            </button>
                                            </td>
                                        </tr>
                                        " ;
