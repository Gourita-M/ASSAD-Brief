<?php 
   ...
   $habinames = "SELECT nom_habi, id_habi
                 FROM habitats;";
   $resul = $conn->query($habinames);
   ...
   if(isset($_POST['adde'])){
    ...
    $addingtosql = "INSERT INTO animaux 
                    (ani_nom, espèce, alimentation, an_image, paysorigine, descriptioncourte, id_habitat)
                    VALUES ('$addname','$espece', '$addfood', '$addimg','$Country', '$Description','$addhabitat');
                    ";

    $conn->query($addingtosql);
